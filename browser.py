...
class MainWindow(QMainWindow):
	...
	def __init__(self, *args, **kwargs):
		...
		next_btn = QAction(QIcon("redo.png"), "Forward", self)
		...
		self.setWindowTitle("Chrone Browser")
	...
	def update_title(self, browser):
		...
		self.setWindowTitle("% s - Chrone Browser" % title)
...
# setting name and icon to the application
app.setApplicationName("Chrone Browser")
